...
const OpenUserChatsList = () => {
    ...
    useEffect(() => {
        const fetchChats = async () => {
            const response = await sendRequest(`/api/chat/user/${userId}/activeChats`, "GET", null, {}, false, true);
                        ...
                        return (
                            <li key={chat._id}>
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-3 rounded transition-colors duration-200 ${isActive
                                ...
                                >
                                    ...
                                    {chat.productDetail && (
                                        <div className="text-sm text-gray-400 mt-1">
                                            ...
                                            <br />
                                            Quantity: {chat.productDetail.quantity || "N/A"},{" "}
                                            Min Order: {chat.productDetail.minimumOrderQuantity || "N/A"}
                                        </div>
                                    )}
                                </button>
